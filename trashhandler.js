...
/////////quoted functions//////////////////
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `𝗦𝗔𝗠𝗦𝗨𝗡𝗚_𝗫𝗠𝗗`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Vinzx,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://files.catbox.moe/yqbio5.jpg' }}}}
...
await trashcore.updateProfileStatus(`✳️ 𝗦𝗔𝗠𝗦𝗨𝗡𝗚_𝗫𝗠𝗗 || ✅ Runtime : ${uptime}`)
...
const qtext = { key: {fromMe: false, participant: `6281519434797@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast"} : {}) },'message': {extendedTextMessage: {text: "𝙈𝙖𝙙𝙚 𝙗𝙮 maxtech 𝙙𝙚𝙫" }}}
...
async function handleMessageRevocation(trashcore, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `𝗦𝗔𝗠𝗦𝗨𝗡𝗚_𝗫𝗠𝗗-ANTIDELETE🔥\n\n` +
...
│ • Owner   : ${ownername}
│ • Version  : ${botversion}
│ • Repo : https://github.com/Maxtech24/SAMSUNG_XMD- 
│ • Runtime  : ${runtime(process.uptime())}\n╰─────────────
`
  reply(botInfo)
}
...
case "xowner": {
  let namaown = `MAXTECH`
  let NoOwn = `256747122756`
  var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    contactMessage: {
      displayName: namaown,
      vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${NoOwn}:+${NoOwn}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:The maxtech Dev\nX-WA-BIZ-NAME:[[ ༑ ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nEND:VCARD`
    }
  }), {
    userJid: m.chat,
    quoted: fkontak
...
} else return reply('Example: 256XXX/@tag')}
break
//==================================================//
...
} else return reply('example:256XX')}
break
//==================================================//
case "close": {
if (!m.isGroup) return reply(mess.group)
...
break;
  ...
  await reply(`✅ Public link successfully created\n\n${d.url}`);
}
break;
//==================================================//   
        case 'ytmp4': {
